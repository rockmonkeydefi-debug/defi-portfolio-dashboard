"""Base chain connector implementation."""
...
class BaseConnector(ChainConnector):
    """Base mainnet RPC connector."""
    ...
    def get_token_transfers(self, wallet: str) -> list[TokenTransfer]:
        ...
        try:
            ...
            logger.info(f"Found {len(transfers)} unique tokens for {wallet} on Base")
            return transfers
